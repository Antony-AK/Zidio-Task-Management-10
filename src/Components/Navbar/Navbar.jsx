  ...
  return (
    <div>
      <nav className='lg:w-[calc(100%-18.22%)] w-[99%] ml-3 border bg-lightase h-14  flex  rounded-l-2xl rounded-r-2xl  justify-between items-center lg:ml-[18.22%] '>
        ...
        <div className='serach-bar md:w-80 bg-white h-9 m-5 rounded-l-2xl rounded-r-2xl md:ml-10 p-1 relative '>
        ...
        <div className="right md:w-80 w-40 flex justify-center items-center p-1 h-12 -ml-18">
          ...
          <div className="Profile flex w-52 p-2 gap-4 justify-center items-center mr-5">
            ...
            <p className='font-base font-medium  sr-only sm:not-sr-only text-lg'>Hanna</p>
          </div>
