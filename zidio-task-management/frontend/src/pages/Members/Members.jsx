...
const Members = () => {
  ...
  return (
    <div className="members w-full h-full flex flex-col gap-5 p-5">
      <div className="title ml-4" data-aos="fade-right" data-aos-duration="2000">
        <h1 className='text-2xl font-semibold'>Members</h1>
      </div>

      <div className="tasks-head-button flex justify-end gap-5 mt-7 md:mt-1 md:mr-20"  data-aos="fade-left" data-aos-duration="2000">
        <button className='add-button' onClick={openModel}> + Member</button>
      </div>

      <div className="members-info w-[95%] mx-auto mt-5 overflow-x-auto">
        <div className="grid grid-cols-7 h-12 border-t border-l min-w-[1200px] lg:min-w-[800px]"  data-aos="fade-up" data-aos-duration="1000">
        ...
        <div className='w-full h-[370px] overflow-y-scroll scrollbar-hide min-w-[1200px] lg:min-w-[800px] '>
          {members.map((info) => (
            <div key={info._id} className="mem-info grid grid-cols-7 bg-white rounded-lg border p-2 hover:border-orange d-flex justify-center items-center gap-3 my-3"  data-aos="fade-up" data-aos-duration="1200">
